...
function getProductInfo(productId, shippingCost) {
    ...
    $.get(requestUrl, function (productJson) {
        ...
        console.log("imagePath:" +  contextPath.substring(0, contextPath.length - 1) + productJson.imagePath);
        ...
        <div class="row m-2">
          <table>
            ...
            <tr>
              <td>Shipping Cost:</td>
              <td>
                <input type="text" required class="form-control m-1 ship-input" value="${shippingCost}" 
