...
public class MasterOrderReportService {
    ...
    public List<ReportItem> getReportDataLast28Days() {
        System.out.println("getReportDataLast28Days...");
    ...
    private List<ReportItem> getReportDataLastXDays(int days)
    {
        ...
        return getReportDataByRateRange(startTime, endTime, "days");
    }

    private List<ReportItem> getReportDataByRateRange(Date startTime, Date endTime, String period)
    {
    ...
    private void calculateSalesForReportData(List<Order> listOrders, List<ReportItem> listReportItems)
    {
        for(Order order : listOrders)
        {
            ...
            if(itemIndex >= 0)
            {
                ...
                reportItem.addNetSales(order.getTotal() - order.getProductCost());
    ...
    public List<ReportItem> getReportDataLastXMonths(int months)
    {
        ...
        return getReportDataByRateRange(startTime, endTime, "months");
